...
socket.onmessage = async function(e){
    ...
    if(type === 'search'){
        ...
        for(let i = 0; i <= data2.length-1; i++){
            let search = `<li class="contact-li" chat-id="chat_${data2[i]['id']}" style="cursor: pointer">
        ...
        message_element = `
			<div class="d-flex mb-4 replied">
				...
				<div class="img_cont_msg">
					<img src="{{ request.user.userprofile.image.url }}" class="rounded-circle user_img_msg">
				</div>
			</div>
	    `
    }else{
